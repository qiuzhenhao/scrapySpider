...
class emailSender(object):
    def __init__(self):
        ...
        self.smtp_user = "15626250225@163.com" # 用于登录smtp服务器的用户名，也就是发送者的邮箱
        self.smtp_pwd = "wq52013140"            # 授权码，和用户名user一起，用于登录smtp， 非邮箱密码
        self.smtp_port = 465                   # smtp服务器SSL端口号，默认是465
        self.sender = "15626250225@163.com"    # 发送方的邮箱
        # self.smtp_host = "smtp.qq.com"        # 发送邮件的smtp服务器（从QQ邮箱中取得）
        # self.smtp_user = "782490630@qq.com" # 用于登录smtp服务器的用户名，也就是发送者的邮箱
        # self.smtp_pwd = "lomryxdnbytobfhe"            # 授权码，和用户名user一起，用于登录smtp， 非邮箱密码
        # self.smtp_port = 25                   # smtp服务器SSL端口号，默认是25
        # self.sender = "782490630@qq.com"    # 发送方的邮箱
